...
class FishDrawable : Drawable() {
    ...
    private val SWAY_DURATION = 180_000
    ...
    private fun calculateValue() {
        ...
        tail1Angle = bodyAngle + (Math.cos(Math.toRadians(currentValue * waveFrequency * 1.5))).toFloat() * 15f - 180f
        endTail1Point = calculatePointF(endBodyPoint, TAIL1_LENGTH, tail1Angle)
    }
